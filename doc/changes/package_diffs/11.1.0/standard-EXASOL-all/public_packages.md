# Public packages comparison between flavor "Standard Exasol All" in 11.1.0 and flavor "Standard Exasol All" in 11.0.0
...
|  2 | ca-certificates         | 20240203~22.04.1             | 20240203~22.04.1             |          | language_deps        |
|  3 | chrpath                 | 0.16-2                       | 0.16-2                       |          | language_deps        |
|  4 | cmake                   | 3.22.1-1ubuntu1.22.04.2      | 3.22.1-1ubuntu1.22.04.2      |          | flavor_base_deps_apt |
|  5 | coreutils               | 8.32-4.1ubuntu1.2            | 8.32-4.1ubuntu1.2            |          | udfclient_deps       |
|  6 | curl                    | 7.81.0-1ubuntu1.23           | 7.81.0-1ubuntu1.23           |          | language_deps        |
|  7 | git                     | 1:2.34.1-1ubuntu1.17         | 1:2.34.1-1ubuntu1.17         |          | flavor_base_deps_apt |
|  8 | gnupg                   | 2.2.27-3ubuntu2.5            | 2.2.27-3ubuntu2.5            |          | language_deps        |
|  9 | ldap-utils              | 2.5.20+dfsg-0ubuntu0.22.04.1 | 2.5.20+dfsg-0ubuntu0.22.04.1 |          | flavor_base_deps_apt |
| 10 | libcurl4-openssl-dev    | 7.81.0-1ubuntu1.23           | 7.81.0-1ubuntu1.23           |          | flavor_base_deps_apt |
| 11 | libexpat1               | 2.4.7-1ubuntu0.7             | 2.4.7-1ubuntu0.7             |          | language_deps        |
| 12 | libexpat1-dev           | 2.4.7-1ubuntu0.7             | 2.4.7-1ubuntu0.7             |          | language_deps        |
| 13 | libhiredis-dev          | 0.14.1-2                     | 0.14.1-2                     |          | flavor_base_deps_apt |
| 14 | libldap2-dev            | 2.5.20+dfsg-0ubuntu0.22.04.1 | 2.5.20+dfsg-0ubuntu0.22.04.1 |          | flavor_base_deps_apt |
| 15 | libldb2                 | 2:2.4.4-0ubuntu0.22.04.2     | 2:2.4.4-0ubuntu0.22.04.2     |          | flavor_base_deps_apt |
| 16 | libleveldb1d            | 1.23-3build1                 | 1.23-3build1                 |          | flavor_base_deps_apt |
| 17 | libnss-db               | 2.2.3pre1-6ubuntu3           | 2.2.3pre1-6ubuntu3           |          | udfclient_deps       |
| 18 | libprotobuf-dev         | 3.12.4-1ubuntu7.22.04.6      | 3.12.4-1ubuntu7.22.04.6      |          | udfclient_deps       |
| 19 | libsasl2-dev            | 2.1.27+dfsg2-3ubuntu1.2      | 2.1.27+dfsg2-3ubuntu1.2      |          | flavor_base_deps_apt |
| 20 | libsmbclient            | 2:4.15.13+dfsg-0ubuntu1.10   | 2:4.15.13+dfsg-0ubuntu1.10   |          | flavor_base_deps_apt |
| 21 | libsmbclient-dev        | 2:4.15.13+dfsg-0ubuntu1.10   | 2:4.15.13+dfsg-0ubuntu1.10   |          | flavor_base_deps_apt |
| 22 | libssl-dev              | 3.0.2-0ubuntu1.21            | 3.0.2-0ubuntu1.21            |          | udfclient_deps       |
| 23 | libxml2-dev             | 2.9.13+dfsg-1ubuntu0.11      | 2.9.13+dfsg-1ubuntu0.11      |          | flavor_base_deps_apt |
| 24 | libzmq3-dev             | 4.3.4-2                      | 4.3.4-2                      |          | udfclient_deps       |
| 25 | locales                 | 2.35-0ubuntu3.13             | 2.35-0ubuntu3.13             |          | udfclient_deps       |
| 26 | maven                   | 3.6.3-5                      | 3.6.3-5                      |          | flavor_base_deps_apt |
| 27 | openjdk-11-jdk-headless | 11.0.30+7-1ubuntu1~22.04     | 11.0.30+7-1ubuntu1~22.04     |          | language_deps        |
| 28 | openssl                 | 3.0.2-0ubuntu1.21            | 3.0.2-0ubuntu1.21            |          | flavor_base_deps_apt |
| 29 | python3-distutils       | 3.10.8-1~22.04               | 3.10.8-1~22.04               |          | language_deps        |
| 30 | python3.10-dev          | 3.10.12-1~22.04.15           | 3.10.12-1~22.04.15           |          | language_deps        |
| 31 | r-base-core             | 4.5.2-1.2204.0               | 4.5.2-1.2204.0               |          | language_deps        |
| 32 | r-base-dev              | 4.5.2-1.2204.0               | 4.5.2-1.2204.0               |          | language_deps        |
| 33 | slapd                   | 2.5.20+dfsg-0ubuntu0.22.04.1 | 2.5.20+dfsg-0ubuntu0.22.04.1 |          | flavor_base_deps_apt |
| 34 | smbclient               | 2:4.15.13+dfsg-0ubuntu1.10   | 2:4.15.13+dfsg-0ubuntu1.10   |          | flavor_base_deps_apt |
| 35 | trivy                   | 0.69.3                       | 0.69.3                       |          | flavor_base_deps_apt |
| 36 | unixodbc-dev            | 2.3.9-5ubuntu0.1             | 2.3.9-5ubuntu0.1             |          | flavor_base_deps_apt |
| 37 | unzip                   | 6.0-26ubuntu3.2              | 6.0-26ubuntu3.2              |          | flavor_base_deps_apt |
| 38 | wget                    | 1.21.2-2ubuntu1.1            | 1.21.2-2ubuntu1.1            |          | flavor_base_deps_apt |
...
| 61 | pyexasol                               | ==2.1.0              | ==2.1.0              |          | flavor_base_deps_python |
| 62 | pyftpdlib                              | ==1.5.9              | ==1.5.9              |          | flavor_base_deps_python |
| 63 | pyodbc                                 | ==5.1.0              | ==5.1.0              |          | flavor_base_deps_python |
| 64 | pysftp                                 | ==0.2.9              | ==0.2.9              |          | flavor_base_deps_python |
| 65 | pysimdjson                             | ==6.0.2              | ==6.0.2              |          | flavor_base_deps_python |
| 66 | pysmbc                                 | ==1.0.25.1           | ==1.0.25.1           |          | flavor_base_deps_python |
| 67 | python-ldap                            | ==3.4.4              | ==3.4.4              |          | flavor_base_deps_python |
| 68 | pytz                                   | ==2024.1             | ==2024.1             |          | flavor_base_deps_python |
| 69 | pyyaml                                 | ==6.0.1              | ==6.0.1              |          | flavor_base_deps_python |
| 70 | redis                                  | ==5.0.4              | ==5.0.4              |          | flavor_base_deps_python |
| 71 | requests                               | ==2.32.4             | ==2.32.4             |          | flavor_base_deps_python |
| 72 | roman                                  | ==4.2                | ==4.2                |          | flavor_base_deps_python |
| 73 | sagemaker                              | ==2.218.1            | ==2.218.1            |          | flavor_base_deps_python |
| 74 | scikit-learn                           | ==1.4.2              | ==1.4.2              |          | flavor_base_deps_python |
| 75 | scipy                                  | ==1.13.0             | ==1.13.0             |          | flavor_base_deps_python |
| 76 | simplejson                             | ==3.19.2             | ==3.19.2             |          | flavor_base_deps_python |
| 77 | ujson                                  | ==5.9.0              | ==5.9.0              |          | flavor_base_deps_python |
