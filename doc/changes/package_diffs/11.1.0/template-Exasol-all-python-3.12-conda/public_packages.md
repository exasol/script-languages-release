# Public packages comparison between flavor "Template Exasol All Python 3.12 Conda" in 11.1.0 and flavor "Template Exasol All Python 3.12 Conda" in 11.0.0
...
|  1 | libprotobuf | =6.31.1             | =6.31.1             |          | udfclient_deps |
|  2 | mamba       | =2.3.3              | =2.3.3              |          | language_deps  |
|  3 | nss         | =3.116              | =3.116              |          | udfclient_deps |
|  4 | numpy       | =1.26.2             | =1.26.2             |          | language_deps  |
|  5 | pandas      | =2.3.3              | =2.3.3              |          | language_deps  |
|  6 | pyarrow     | =22.0.0             | =22.0.0             |          | language_deps  |
|  7 | python      | =3.12.11            | =3.12.11            |          | language_deps  |
