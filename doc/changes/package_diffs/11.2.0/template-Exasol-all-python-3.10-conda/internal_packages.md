# Internal packages comparison between flavor "Template Exasol All Python 3.10 Conda" in 11.2.0 and flavor "Template Exasol All Python 3.10 Conda" in 11.1.1
...
|    | Package      | Version in 11.1.1   | Version in 11.2.0   | Status   | Build-Step   |
|---:|:-------------|:--------------------|:--------------------|:---------|:-------------|
|  0 | gcc_linux-64 | =12.4.0             |                     | REMOVED  | build_deps   |
|  1 | gxx_linux-64 | =12.4.0             |                     | REMOVED  | build_deps   |
|  2 | gcc          |                     | =12.4.0             | NEW      | build_deps   |
|  3 | gxx          |                     | =12.4.0             | NEW      | build_deps   |
|  4 | bazel        | =8.3.1              | =8.3.1              |          | build_deps   |
|  5 | chrpath      | =0.16               | =0.16               |          | build_deps   |
|  6 | make         | =4.3                | =4.3                |          | build_deps   |
