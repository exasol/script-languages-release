# Internal packages comparison between flavor "Template Exasol 8 Python 3.12 Cuda Conda" in 11.2.0 and flavor "Template Exasol 8 Python 3.12 Cuda Conda" in 11.2.0
...
|  2 | gcc       | =13.4.0             | =13.4.0             |          | build_deps   |
|  3 | gxx       | =13.4.0             | =13.4.0             |          | build_deps   |
