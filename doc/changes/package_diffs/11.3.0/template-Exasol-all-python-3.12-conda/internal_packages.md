# Internal packages comparison between flavor "Template Exasol All Python 3.12 Conda" in 11.2.0 and flavor "Template Exasol All Python 3.12 Conda" in 11.2.0
...
|  2 | gcc       | =15.1.0             | =15.1.0             |          | build_deps   |
|  3 | gxx       | =15.1.0             | =15.1.0             |          | build_deps   |
