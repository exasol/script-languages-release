# Internal packages comparison between flavor "Template Exasol All Python 3.10 Conda" in 11.4.0 and flavor "Template Exasol All Python 3.10 Conda" in 11.3.0
...
|  3 | gcc       | =12.4.0             | =12.4.0             |          | build_deps   |
|  4 | gxx       | =12.4.0             | =12.4.0             |          | build_deps   |
|  5 | make      | =4.3                | =4.3                |          | build_deps   |
