# Public packages comparison between flavor "Template Exasol All Python 3.10" in 11.4.0 and flavor "Template Exasol All Python 3.10" in 11.3.0
...
|  3 | tzdata               | 2026*               | 2026*               |          | flavor_base_deps |
...
|  7 | python3-distutils    | 3.10.8*             | 3.10.8*             |          | language_deps    |
|  8 | python3.10-dev       | 3.10.12*            | 3.10.12*            |          | language_deps    |
