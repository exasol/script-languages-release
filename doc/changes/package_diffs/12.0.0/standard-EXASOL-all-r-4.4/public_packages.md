# Public packages comparison between flavor "Standard Exasol All R 4.4" in 12.0.0 and flavor "Standard Exasol All R 4.4" in 11.3.0
...
|  4 | unixodbc-dev         | 2.3.9-5ubuntu*      | 2.3.9-5ubuntu*      |          | flavor_base_deps |
|  5 | unzip                | 6.0-26ubuntu*       | 6.0-26ubuntu*       |          | flavor_base_deps |
|  6 | wget                 | 1.21.2-2ubuntu*     | 1.21.2-2ubuntu*     |          | flavor_base_deps |
...
| 10 | libexpat1            | 2.4.7-1ubuntu*      | 2.4.7-1ubuntu*      |          | language_deps    |
| 11 | libexpat1-dev        | 2.4.7-1ubuntu*      | 2.4.7-1ubuntu*      |          | language_deps    |
| 12 | r-base-core          | 4.5.2-1.2204.0      | 4.5.2-1.2204.0      |          | language_deps    |
| 13 | r-base-dev           | 4.5.2-1.2204.0      | 4.5.2-1.2204.0      |          | language_deps    |
| 14 | coreutils            | 8.32-4.1ubuntu*     | 8.32-4.1ubuntu*     |          | udfclient_deps   |
| 15 | libnss-db            | 2.2.3pre1-6ubuntu*  | 2.2.3pre1-6ubuntu*  |          | udfclient_deps   |
| 16 | libprotobuf-dev      | 3.12.4-1ubuntu*     | 3.12.4-1ubuntu*     |          | udfclient_deps   |
| 17 | libssl-dev           | 3.0.2-0ubuntu*      | 3.0.2-0ubuntu*      |          | udfclient_deps   |
| 18 | libzmq3-dev          | 4.3.4-2             | 4.3.4-2             |          | udfclient_deps   |
| 19 | locales              | 2.35-0ubuntu*       | 2.35-0ubuntu*       |          | udfclient_deps   |
...
| 29 | nloptr        | 2.2.1               | 2.2.1               |          | flavor_base_deps |
