# Internal packages comparison between flavor "Template Exasol 8 Python 3.10 Cuda Conda" in 12.0.0 and flavor "Template Exasol 8 Python 3.10 Cuda Conda" in 11.3.0
