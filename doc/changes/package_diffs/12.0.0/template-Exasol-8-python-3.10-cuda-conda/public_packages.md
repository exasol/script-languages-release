# Public packages comparison between flavor "Template Exasol 8 Python 3.10 Cuda Conda" in 12.0.0 and flavor "Template Exasol 8 Python 3.10 Cuda Conda" in 11.3.0
...
|---:|:----------------|:---------------------|:---------------------|:---------|:-----------------|
|  0 | bzip2           | 1.0.8-5build1        | 1.0.8-*              | UPDATED  | conda_deps       |
