# Internal packages comparison between flavor "Template Exasol All Python 3.12 Conda" in 12.0.0 and flavor "Template Exasol All Python 3.12 Conda" in 11.3.0
...
|  3 | gcc       | =15.1.0             | =15.1.0             |          | build_deps   |
|  4 | gxx       | =15.1.0             | =15.1.0             |          | build_deps   |
