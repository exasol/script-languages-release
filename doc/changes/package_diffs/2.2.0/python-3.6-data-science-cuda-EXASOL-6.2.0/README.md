# Package Version Comparison between Python-3.6-data-science-cuda-exasol-6.2.0 flavor in 2.2.0 and Python-3.6-data-science-cuda-exasol-6.2.0 flavor in 2.1.0
...
- Comparison of build step Language_deps
  ...
  - [Comparison of package lists Python3 Pip Packages and Pip3 Packages](language_deps/python3_pip_packages_diff.md)
- Comparison of build step Flavor_base_deps
  ...
  - [Comparison of package lists Python3 Pip Packages and Pip3 Packages](flavor_base_deps/python3_pip_packages_diff.md)
