# Package Version Comparison between Standard-exasol-all-python-3.10 flavor in 9.3.0 and Standard-exasol-all flavor in 9.2.0
...
- Comparison of build step Security_scan
  - [New Apt Get Packages Trivy](security_scan/apt_get_packages_trivy_diff.md)
  - [New Apt Get Packages Trivy Deps](security_scan/apt_get_packages_trivy_deps_diff.md)
